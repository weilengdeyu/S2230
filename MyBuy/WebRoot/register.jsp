...
<div id="register" class="wrap">
	<div class="shadow">
		...
		<div class="box">
			...
			<form id="regForm" method="post" action="RegisterServelt" >
				<table>
					<tr>
						<td class="field">用户名(*)：</td>
						<td>
							<input class="text" type="text" name="userId"  id="userId" maxlength="10" onblur="CheckUserName()"  />
...
<div id="footer">
	Copyright &copy; 2015 微冷的雨 All Rights Reserved. 京ICP证1000001号
</div>
</body>
</html>
